class Carousel {
  constructor(p) {
    const settings = {...{containerID: '#carousel', interval: 2000, isPlaying: true, slideID: '.slide'}, ...p};
  ...
  _initControls() {
    ...
    const PAUSE = `<span id="pause-btn" class="control-pause"><span id="fa-pause-icon">${this.FA_PAUSE}</span><span id="fa-play-icon">${this.FA_PLAY}</span></span>`;
